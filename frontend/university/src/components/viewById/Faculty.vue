<template>
  ...
  <div class="icons">
    <div><router-link class="edit" :to="{name:'editFaculty', params:{fe_id:faculty.id}}">
      <font-awesome-icon class="icon" icon="pen-to-square" />
    </router-link></div>
    <div class="delete" @click="deleteFaculty">
  ...
  <div v-if="faculty">
    ...
    <img class="img" :src="faculty.imgSrc"/>
<p>{{faculty.description}}</p>
    <router-link class="ref" :to="{name:'faculty_departments', params:{f_id:faculty.id}}">See departments of faculty</router-link>
  </div>
